...
08. Copy the BattleyeFilters from "infiSTAR.de_A3\YOURMOD_BattleEye_Filters" into your Battleye folder on the Server. Be sure to copy them into the correct folder.
	...
	I am not affiliated with Battleye in any way. Guides & help regarding BE Filters can be found here:
		...
		1. This is a program from one of the developers of Exilemod:
		...
		2. BattlEye Filters are time consuming and are different if you are running a modifed version.
